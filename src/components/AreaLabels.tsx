      ...
      {extraInfo && (
        <div className="h-fit flex flex-col justify-evenly items-center text-white font-Inter overflow-y-scroll space-y-3">
          ...
          >
            ...
            <span className="relative px-5 py-2.5 transition-all ease-in duration-200 w-[9.5rem] h-[2.5rem] bg-white dark:bg-gray-900 rounded-2xl group-hover:bg-opacity-0">
              SET AREA
            </span>
          </button>
        </div>
