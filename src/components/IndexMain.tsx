...
function IndexMain() {
  return (
    <div className='border-solid border-red-900 h-full flex justify-start items-center flex-col space-y-9 mt-[8rem]'>
      ...
      <h1 className='font-rajad font-extrabold text-8xl animate-pulse text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-primary to-amber-300 py-4'>
        LOADSHEDDING ?
      </h1>
